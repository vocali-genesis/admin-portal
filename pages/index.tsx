  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white">
      <div className="relative w-12 h-12">
        <div className="absolute top-0 left-0 right-0 bottom-0 border-4 rounded-full"></div>
        <div
          className="absolute top-0 left-0 right-0 bottom-0 border-4 rounded-full animate-spin"
